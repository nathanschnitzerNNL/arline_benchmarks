...
u2(-1*pi,1*pi) q[13];
u2(0,0) q[15];
u3(-1*pi,4.266489497017567,-4.266489497017567) q[5];
u2(-1*pi,1*pi) q[1];
u2(-1*pi,1*pi) q[4];
...
cz q[8], q[1];
cz q[12], q[13];
u2(-0.891798966734246,0.891798966734246) q[5];
u2(-1*pi,1*pi) q[4];
...
cz q[12], q[2];
u3(-1*pi,4.4743713152460876,-4.4743713152460876) q[1];
u2(-4.033391620324039,4.033391620324039) q[5];
cz q[5], q[11];
cz q[1], q[4];
cz q[12], q[9];
cz q[5], q[3];
u2(0,0) q[11];
u2(-2.0468316573862597,2.0468316573862597) q[1];
...
u2(-1*pi,1*pi) q[6];
u2(-1*pi,1*pi) q[15];
u2(1.0947609962035334,-1.0947609962035334) q[1];
cz q[12], q[6];
cz q[1], q[8];
...
u2(-1*pi,1*pi) q[6];
u2(-3.6176279841811567,3.6176279841811567) q[1];
u2(-1.25*pi,1.25*pi) q[8];
cz q[6], q[14];
cz q[5], q[12];
cz q[8], q[1];
...
cz q[5], q[7];
cz q[0], q[8];
u2(-0.47603533059136327,0.47603533059136327) q[1];
cz q[1], q[14];
cz q[3], q[8];
u2(-1*pi,1*pi) q[11];
u2(-0.891798966734246,0.891798966734246) q[5];
...
sdg q[7];
cz q[0], q[1];
u2(0.6789973600606505,-0.6789973600606505) q[5];
cz q[14], q[5];
...
rz(-1*pi) q[8];
rz(0.25*pi) q[0];
u3(-1*pi,1.3327786616562947,-1.3327786616562947) q[1];
u2(-1*pi,1*pi) q[6];
u3(-1*pi,-0.8385985650658472,0.8385985650658472) q[5];
u2(0,0) q[13];
rz(-1*pi) q[6];
