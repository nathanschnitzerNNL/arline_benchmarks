...
u2(0,0) q[3];
u3(-1*pi,1.9634954084936207,-1.9634954084936207) q[7];
...
u3(-0.75*pi,0.75*pi,-0.75*pi) q[9];
...
cz q[4], q[13];
cz q[7], q[12];
u3(-1*pi,3.5342917352885173,-3.5342917352885173) q[6];
u2(-0.25*pi,0.25*pi) q[15];
u2(0,0) q[3];
...
u2(-1*pi,1*pi) q[4];
u2(0,0) q[10];
u3(-1*pi,-0.39269908169872414,0.39269908169872414) q[1];
u2(-0.75*pi,0.75*pi) q[5];
rz(-1*pi) q[4];
rz(0.75*pi) q[5];
u2(-1.25*pi,1.25*pi) q[13];
