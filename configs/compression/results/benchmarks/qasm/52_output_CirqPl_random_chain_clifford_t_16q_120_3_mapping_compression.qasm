...
cz q[14], q[1];
rz(-1*pi) q[9];
u2(-2.958245734649605,2.958245734649605) q[14];
u2(-0.0669857356792514,0.0669857356792514) q[1];
rz(-0.1833469189401882) q[14];
rz(1.637782062474148) q[1];
cz q[14], q[0];
cz q[15], q[1];
cz q[15], q[12];
u2(0,0) q[14];
