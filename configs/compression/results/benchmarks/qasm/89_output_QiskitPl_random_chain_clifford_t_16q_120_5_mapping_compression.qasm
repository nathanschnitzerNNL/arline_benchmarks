...
cx q[13], q[14];
cx q[14], q[13];
u3(1*pi,0.29755781,-2.8440348) q[14];
cx q[14], q[15];
u3(1*pi,-0.50047404,-2.0712704) q[14];
...
cx q[10], q[11];
cx q[11], q[10];
u2(-0.50*pi,-0.097189947) q[11];
cx q[11], q[12];
u2(-1*pi,-0.50*pi) q[11];
u3(1.5721196,1.7511069e-06,-1.569473) q[12];
cx q[11], q[12];
u2(0.75*pi,0.50*pi) q[11];
u3(1.5721196,-1.4736064,-0.50*pi) q[12];
cx q[12], q[13];
cx q[13], q[12];
cx q[12], q[13];
cx q[13], q[4];
...
cx q[13], q[14];
cx q[14], q[13];
u3(3.1402694,0.50*pi,0.047889034) q[13];
cx q[15], q[14];
u1(-0.50*pi) q[14];
cx q[15], q[0];
cx q[0], q[15];
...
cx q[3], q[4];
cx q[4], q[3];
u3(1.5721196,0.50*pi,-0.50*pi) q[7];
cx q[9], q[10];
cx q[10], q[9];
cx q[10], q[11];
cx q[12], q[11];
...
cx q[12], q[13];
u2(2.3083055,-1*pi) q[12];
cx q[11], q[12];
cx q[12], q[11];
cx q[11], q[12];
u2(-0.0013232938,-1*pi) q[13];
cx q[13], q[14];
cx q[14], q[13];
cx q[13], q[14];
cx q[14], q[3];
