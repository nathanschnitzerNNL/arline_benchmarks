...
cz q[0], q[3];
cz q[10], q[8];
u3(-1*pi,3.796048205371547,-3.796048205371547) q[13];
cz q[0], q[12];
cz q[13], q[2];
u2(0,0) q[3];
...
u2(0.5235129401660594,-0.5235129401660594) q[13];
cz q[13], q[5];
cz q[9], q[6];
...
cz q[4], q[0];
cz q[10], q[7];
u2(-2.6180797134237337,2.6180797134237337) q[13];
u2(-0.25*pi,0.25*pi) q[5];
u2(-1*pi,1*pi) q[9];
u2(-1*pi,1*pi) q[6];
cz q[1], q[13];
