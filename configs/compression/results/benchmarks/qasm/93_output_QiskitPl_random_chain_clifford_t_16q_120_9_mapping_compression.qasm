...
qreg q[16];
creg c[16];
u3(1*pi,0.58117859,-0.98961773) q[0];
cx q[1], q[2];
u1(0.50*pi) q[2];
cx q[4], q[3];
u1(0.25*pi) q[4];
...
u3(1.5721196,-1.4736064,-0.50*pi) q[11];
cx q[12], q[11];
...
cx q[12], q[13];
cx q[12], q[11];
u3(0.0013232938,-0.50*pi,0.49486037) q[12];
cx q[14], q[15];
cx q[15], q[14];
cx q[14], q[15];
cx q[0], q[15];
...
cx q[2], q[1];
cx q[1], q[2];
u3(1.504602,0.78407197,-3.1415049) q[4];
cx q[3], q[4];
cx q[4], q[3];
cx q[3], q[4];
cx q[7], q[6];
