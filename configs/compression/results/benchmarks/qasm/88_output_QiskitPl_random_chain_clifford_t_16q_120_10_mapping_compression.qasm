...
cx q[9], q[10];
cx q[8], q[9];
u3(0.25*pi,-0.50*pi,-0.1424483) q[8];
u2(-0.50*pi,-2.2922398) q[9];
cx q[4], q[13];
cx q[12], q[13];
cx q[13], q[12];
cx q[12], q[13];
...
cx q[7], q[8];
u3(1.428348,0.50*pi,-0.50*pi) q[7];
cx q[7], q[10];
u1(-0.50*pi) q[10];
cx q[10], q[11];
cx q[11], q[10];
...
u2(0,0.50*pi) q[9];
cx q[9], q[10];
u3(1.0848761,-0.92674942,-2.5851617) q[10];
cx q[10], q[11];
u2(0,0.50*pi) q[10];
...
cx q[11], q[12];
cx q[11], q[10];
u3(0.75*pi,0.50*pi,0.25*pi) q[10];
cx q[12], q[13];
cx q[13], q[4];
cx q[14], q[13];
cx q[13], q[14];
