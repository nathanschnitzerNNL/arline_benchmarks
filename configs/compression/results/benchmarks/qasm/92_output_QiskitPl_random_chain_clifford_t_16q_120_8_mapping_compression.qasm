...
u3(1.5721196,0.76512862,-0.50*pi) q[11];
cx q[13], q[12];
cx q[12], q[13];
cx q[13], q[12];
cx q[13], q[14];
...
cx q[0], q[15];
u2(-1*pi,-0.50*pi) q[0];
u3(0.0013232938,-0.50*pi,-0.50*pi) q[15];
cx q[15], q[14];
cx q[14], q[15];
cx q[15], q[14];
cx q[14], q[13];
...
cx q[12], q[11];
cx q[11], q[12];
u3(0.0013232938,-0.50*pi,-0.50*pi) q[11];
cx q[10], q[11];
u2(-1*pi,-0.50*pi) q[10];
u3(1.5721196,1.7511069e-06,-1.569473) q[11];
cx q[10], q[11];
...
cx q[14], q[13];
cx q[13], q[14];
u2(-0.50*pi,-3.0934899) q[14];
cx q[14], q[15];
u2(-1*pi,-0.50*pi) q[14];
u3(1.5721196,1.7511069e-06,-1.569473) q[15];
cx q[14], q[15];
u2(0.50*pi,0.50*pi) q[14];
u3(1.5721196,3.0934899,-0.50*pi) q[15];
cx q[15], q[0];
cx q[0], q[15];
cx q[15], q[0];
cx q[5], q[4];
...
u3(0.0018714197,-0.75*pi,-0.75*pi) q[8];
cx q[7], q[8];
u2(0,-0.50*pi) q[7];
u3(1.569473,1.569473,-1*pi) q[8];
cx q[7], q[8];
u2(-1*pi,-0.50*pi) q[7];
cx q[7], q[6];
cx q[6], q[5];
